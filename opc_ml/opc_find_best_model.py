...
X = pd.read_csv("M:\\Ransomware_Lab\\ransomware_llm_analyzer\\opc_ml\\opc_data_tfidf.csv").drop(columns=["label"]).values
y = pd.read_csv("M:\\Ransomware_Lab\\ransomware_llm_analyzer\\opc_ml\\opc_data_tfidf.csv")["label"].values
