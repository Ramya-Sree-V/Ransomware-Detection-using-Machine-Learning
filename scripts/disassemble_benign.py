...
SAMPLES_DIR = os.path.expanduser("~/ransomware_analysis/Benign_samples/benign_exe_samples/")
DISASM_DIR = os.path.expanduser("~/ransomware_analysis/Benign_samples/disassembly_benign")
